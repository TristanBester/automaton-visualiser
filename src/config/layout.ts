...
const LEVEL_2_GREEN = generateXPositions(
  BASE.X + BASE.GREEN_SHIFT,
  3,
  BASE.LEVEL_2_SPACING,
);
...
const LEVEL_3_GREEN_1 = generateXPositions(
  BASE.X + BASE.GREEN_SHIFT - 1300,
  5,
  BASE.NODE_SPACING,
);
const LEVEL_3_GREEN_2 = generateXPositions(
  BASE.X + BASE.GREEN_SHIFT + 200,
  5,
  BASE.NODE_SPACING,
);
const LEVEL_3_GREEN_3 = generateXPositions(
  BASE.X + BASE.GREEN_SHIFT + 1700,
  5,
  BASE.NODE_SPACING,
);

// Generate container X positions
const CONTAINER_LEVEL_3_RED = generateContainerPositions(
  -1400,
  3,
  BASE.CONTAINER_SPACING,
);
const CONTAINER_LEVEL_3_GREEN = generateContainerPositions(
  -1400 + BASE.GREEN_SHIFT,
  3,
  BASE.CONTAINER_SPACING,
);
